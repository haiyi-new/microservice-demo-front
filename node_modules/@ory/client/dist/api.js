...
exports.ProjectInviteStatusEnum = {
    Pending: 'pending',
    Accepted: 'accepted',
    Declined: 'declined',
    Expired: 'expired',
...
class ProjectApi extends base_1.BaseAPI {
    ...
    getProjectMembers(requestParameters, options) {
        return exports.ProjectApiFp(this.configuration).getProjectMembers(requestParameters.projectId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves project metrics for the specified event type and time range
    ...
    removeProjectMember(requestParameters, options) {
        return exports.ProjectApiFp(this.configuration).removeProjectMember(requestParameters.projectId, requestParameters.memberId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Use this API to set your active project in the Ory Network Console UI.
     * @summary Sets the Ory Network Project active in the Ory Network Console
